...
CREATE TABLE `librarians` (
  ...
  CONSTRAINT `librarian_has_a_library` FOREIGN KEY (`libraryID`) REFERENCES `libraries` (`id`),
...
INSERT INTO `librarians` VALUES (1,'Head of Audiobooks',123),(3,'Head of Hardcovers',123),(5,'Head of Children\'s Books',234);
